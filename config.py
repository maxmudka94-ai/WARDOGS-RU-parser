...
# Ручной + автоматический перевод (как в discord-bot-new) — через Gemini
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "").strip() or "AQ.Ab8RN6JRH5FJEn7DBPJMYH97nrhBmmgBT1QLkCVQn_eMnuQYdg"
